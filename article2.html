...
<div class="central">
	 ...
	 <h1 class="heading">Season 2 Summary</h1> 
    ...
    <figure class="figure">
	    <br>
	    <img src="madrid.jpg" class="mainpic"> 
	    <figcaption class="figback">Real Madrid led by Wudinhita celebrate another league title!</figcaption>
	    </figure>	    
	     <br>

    
    
	<span class="size"> Elpesidente,<i> 7<sup>th</sup> July 2020. </i></span>
    <br>
	    <h3>SUPER LEAGUE</h3>  
...
<br>
	    <h3>DIVISION 2</h3>
<p>Moving on to d2, Kontra and Cagliari have been on fire all season along with Zenit and it was rarely in doubt these 2 would be promoted. Cagliari came out top to win the title and both go up. For the 3rd automatic spot Snakeater and his
...
the World club cup which sees a smaller restructure format next season and Wildbills Zenit with some amazing results to win the Grand Cup, another cup becoming extinct with the new format next season and reintroduction of the champions
league, lowropa cup and FA cup as the 3 main cup competitions.</p><br>
...
<li>D3 Champ- Goatinho- Celta Vigo</li>
	<li>WCC- Vegestr0x- Lazio</li>
	<li>Grand Cup- Wildbill- Zenit</li>
</ul>
